"""
Ce module définit les langages de programmation supportés pour le chunking de documents.

Variables:
    SUPPORTED_LANGUAGES (list): Une liste de dictionnaires définissant les langages supportés.
"""
